...
int main(int argc, char **argv) {
    ...
    */
    ...
    size_t shm_mem = (red_thr_blc <= 32) ? 2 * red_thr_blc * sizeof(float) * 4 : red_thr_blc * sizeof(float) * 4;

    if (ispow2(N)) {
        switch (red_thr_blc) {
            case 1024:
                centerOfMass<1024, true> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
            break;

            case 512:
                centerOfMass<512, true> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
            break;

            case 256:
                centerOfMass<256, true> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
            break;

            case 128:
                centerOfMass<128, true> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
            break;

            case 64:
                centerOfMass<64, true> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
            break;

            case 32:
                centerOfMass<32, true> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
            break;

            case 16:
                centerOfMass<16, true> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
            break;

            case 8:
                centerOfMass<8, true> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
            break;

            case 4:
                centerOfMass<4, true> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
            break;

            case 2:
                centerOfMass<2, true> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
            break;

            case 1:
                centerOfMass<1, true> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
            break;
        }
        ...
        switch (red_thr_blc) {
            case 1024:
                centerOfMass<1024, false> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
                break;

            case 512:
                centerOfMass<512, false> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
                break;

            case 256:
                centerOfMass<256, false> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
                break;

            case 128:
                centerOfMass<128, false> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
                break;

            case 64:
                centerOfMass<64, false> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
                break;

            case 32:
                centerOfMass<32, false> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
                break;

            case 16:
                centerOfMass<16, false> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
                break;

            case 8:
                centerOfMass<8, false> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
                break;

            case 4:
                centerOfMass<4, false> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
                break;

            case 2:
                centerOfMass<2, false> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
                break;

            case 1:
                centerOfMass<1, false> <<< reductionGrid, red_thr_blc, shm_mem >>> (
                        particles_gpu, &comGPU[0].x, &comGPU[0].y, &comGPU[0].z, &comGPU[0].w, &lock[0], N
                );
                break;
        }
